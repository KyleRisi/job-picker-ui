...
export const homepageV1Metadata: Metadata = {
...
/* ─── Page ─── */
export async function HomepageV1() {
          ...
          <div className="grid gap-10 md:grid-cols-2">
            ...
            <div className="text-center">
              <Link
                ...
                className="mx-auto block aspect-[1080/1571] w-full max-w-[280px] overflow-hidden transition hover:brightness-105"
