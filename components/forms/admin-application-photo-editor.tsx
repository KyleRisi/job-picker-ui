...
export function AdminApplicationPhotoEditor({
  ...
  async function upload(dataUrl: string | null) {
    ...
    setMessage('');
    setIsError(false);
    const res = await fetch(`/api/admin/applications/${applicationId}/photo`, {
      method: 'PATCH',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ profile_photo_data_url: dataUrl })
    });
  ...
  return (
    <div className="relative w-36 shrink-0">
      <div
        ...
        aria-label="Upload or change applicant photo"
        role="button"
        tabIndex={0}
        onKeyDown={(e) => {
      ...
      >
        {preview ? (
          ...
          <Image
            ...
            alt="No profile photo placeholder"
            fill
            sizes="144px"
            className="object-cover"
          />
