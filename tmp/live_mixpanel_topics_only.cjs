...
await page.goto(`${BASE}/topics`,{waitUntil:'networkidle'}); await wait(3500);
...
await page.locator('[data-discovery-event="topic_card_clicked"]').first().click({force:true}); await wait(9000);
